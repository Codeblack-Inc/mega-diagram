...
- Circle fill: very low-opacity tint — `rgba(23,21,43,0.04)` for ink set, `rgba(104,101,123,0.05)` for muted. Tints compound naturally in overlap regions.
...
- **Coral accent** on the ONE focal intersection — the "sweet spot". Either coral label stroke OR clipPath-bounded coral fill tint (`rgba(47,111,219,0.10)`).
