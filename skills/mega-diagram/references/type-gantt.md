...
- **Phase grouping:** a subtle zone rect (same pattern as architecture zone) behind each phase's rows, with an eyebrow label in the top-left margin. Use `rgba(23,21,43,0.02)` fill, `rgba(23,21,43,0.10)` stroke.
...
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(104,101,123,0.15)" stroke="#68657b" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#17152b" font-size="10" font-weight="600"
      font-family="'Geist', sans-serif">Task name</text>

<!-- Focal task -->
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(47,111,219,0.12)" stroke="#2f6fdb" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#2f6fdb" font-size="10" font-weight="600"
