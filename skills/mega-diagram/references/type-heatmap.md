...
<rect x="160" y="64" width="116" height="56" fill="#ffffff"/>
...
<rect x="520" y="124" width="116" height="56" fill="#ffffff"/>
<rect data-row="payments" data-col="S4" data-value="47" data-focal="true"
      x="520" y="124" width="116" height="56"
      fill="rgba(47,111,219,0.85)" stroke="#2f6fdb" stroke-width="1.2"/>
```
