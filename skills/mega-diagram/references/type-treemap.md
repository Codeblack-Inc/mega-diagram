...
<!-- Cell body -->
<rect x="X" y="Y" width="W" height="H" rx="2" data-share="18.29" fill="rgba(23,21,43,0.16)" stroke="rgba(23,21,43,0.30)" stroke-width="1"/>
<text x="X+16" y="Y+28" fill="#17152b" font-size="13" font-weight="600" font-family="'Geist', sans-serif">NAME</text>
<text x="X+16" y="Y+46" fill="#68657b" font-size="9" font-family="'Geist Mono', monospace">VALUE · SHARE</text>
```

Focal cell: replace the fill with `rgba(47,111,219,0.16)` and the stroke with `#2f6fdb` at 1.5px.
...
```svg
<rect x="580" y="106" width="216" height="314" rx="2" data-column="mobile" data-segment="macOS" data-amount="1980" fill="rgba(47,111,219,0.16)" stroke="#2f6fdb" stroke-width="1.5"/>
<text data-column="mobile" data-segment="macOS" data-role="label" x="596" y="152" fill="#68657b" font-size="9" font-family="'Geist Mono', monospace">1,980 min · 83% of mobile</text>
<text data-column="mobile" data-role="caption" x="688" y="438" fill="#68657b" font-size="9" font-family="'Geist Mono', monospace" text-anchor="middle">mobile · 24%</text>
<text data-segment="macOS" data-role="key" x="344" y="497" fill="#68657b" font-size="8.5" font-family="'Geist', sans-serif">macOS</text>
```
