...
<text x="904" y="36" fill="#17152b" font-size="14" font-style="italic"
...
<path d="M 820 44 Q 700 84 520 216" fill="none"
      stroke="rgba(23,21,43,0.40)" stroke-width="1" stroke-dasharray="4,3"/>
<!-- 3. Landing dot -->
<circle cx="520" cy="216" r="2" fill="#17152b"/>
```
...
| Intent | Text | Leader |
|---|---|---|
| Neutral aside | ink `#17152b` | `rgba(23,21,43,0.40)` |
| Focal / accent | coral `#2f6fdb` | `rgba(47,111,219,0.50)` |
| Tertiary (muted) | muted `#68657b` | `rgba(23,21,43,0.30)` |
