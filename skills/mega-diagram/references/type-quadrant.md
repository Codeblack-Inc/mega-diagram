...
- **Axis lines**: `ink` (`#17152b`), `stroke-width: 1.2`, `marker-start` + `marker-end` both pointing outward.
- **Focal quadrant tint**: `rgba(47,111,219,0.04)` full rect behind the focal cell.
