...
Redraw the Mermaid source at `$1` in this skill's design system, following [`skills/mega-diagram/references/import-mermaid.md`](../skills/mega-diagram/references/import-mermaid.md) and [`skills/mega-diagram/references/output-spec.md`](../skills/mega-diagram/references/output-spec.md). Treat those references as the source of truth.
