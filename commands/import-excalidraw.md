...
Redraw the Excalidraw scene at `$1` in this skill's design system, following [`skills/mega-diagram/references/import-excalidraw.md`](../skills/mega-diagram/references/import-excalidraw.md) and [`skills/mega-diagram/references/output-spec.md`](../skills/mega-diagram/references/output-spec.md). Treat those references as the source of truth — don't reimplement the logic here.
...
- Type is chosen from the extracted structure; `--type` forces one of the visual
  types in [`SKILL.md` §3](../skills/mega-diagram/SKILL.md).
