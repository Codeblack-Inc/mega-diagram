---
description: Run one-shot environment diagnostics for mega-diagram readiness
...
Run environment diagnostics for mega-diagram by following [`skills/mega-diagram/references/doctor.md`](../skills/mega-diagram/references/doctor.md). Treat that reference as the source of truth and do not reimplement its logic here.
