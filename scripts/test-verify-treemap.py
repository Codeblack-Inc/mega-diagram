...
GOOD = ROOT / "skills/mega-diagram/assets/example-treemap.html"
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as raw:
        ...
        left_over = source.replace(
            '<text x="804" y="324" fill="#17152b" font-size="12" font-weight="600"',
            '<text x="804" y="324" text-anchor="end" fill="#17152b" font-size="12" font-weight="600"',
        )
        if left_over == source:
        ...
        top_over = source.replace(
            '<text x="592" y="68" fill="#17152b" font-size="13"',
            '<text x="592" y="44" fill="#17152b" font-size="13"',
        )
        if top_over == source:
        ...
        asia_mask = '<rect x="40" y="40" width="532" height="380" rx="2" fill="#ffffff"/>'
        ...
        asia_body = (
            ...
            'data-share="59.04" fill="rgba(47,111,219,0.16)" '
            'stroke="#2f6fdb" stroke-width="1.5"/>'
        )
