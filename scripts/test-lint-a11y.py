...
MOTION_TEMPLATE = ROOT / "skills/mega-diagram/assets/template-motion.html"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="lint-a11y-") as temp_dir:
        ...
        (project / "skills/mega-diagram/assets").mkdir(parents=True)
        (project / "skills/mega-diagram/references").mkdir(parents=True)
        shutil.copy2(LINTER, project / "scripts/lint-skin.py")
        shutil.copy2(
            ROOT / "skills/mega-diagram/references/style-guide.md",
            project / "skills/mega-diagram/references/style-guide.md",
        )
        project_style = project / "skills/mega-diagram/references/style-guide.md"
        ...
        (project / "skills/mega-diagram/assets/example-baseline.html").write_text(
        ...
        (project / "skills/mega-diagram/assets/template.html").write_text(
