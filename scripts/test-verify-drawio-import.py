...
REFERENCE = Path("skills/mega-diagram/references/import-drawio.md")
EXAMPLE = Path("skills/mega-diagram/assets/example-import-drawio.html")
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="mega-diagram-drawio-test-") as tmp_dir:
        ...
        valid_name = "/mega-diagram:import-drawio"
