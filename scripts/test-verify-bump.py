...
GOOD = ROOT / "skills/mega-diagram/assets/example-bump.html"
...
FOCAL_PATH = ('<path data-series="legacy-http" data-ranks="1,2,4,6" '
              ...
              'stroke="#2f6fdb" stroke-width="2.4"/>')
...
def synthetic(n_series, n_cols, top=100, pitch=40, x0=200, dx=150):
    ...
    for s in range(n_series):
        ...
        focal = s == 0
        stroke = "#2f6fdb" if focal else "rgba(23,21,43,0.70)"
    ...
    with tempfile.TemporaryDirectory() as raw:
        ...
        case(
            ...
            source.replace('data-series="authx" data-ranks="2,3,3,2"',
                  ...
                  .replace('<circle cx="680" cy="144" r="3" fill="rgba(23,21,43,0.80)"/>',
                           '<circle cx="680" cy="88" r="3" fill="rgba(23,21,43,0.80)"/>')
                  .replace('data-series="authx" data-end="last" data-role="rank" x="696" y="147.5" fill="#68657b" font-size="9" font-family="\'Geist Mono\', monospace">#2<',
                           'data-series="authx" data-end="last" data-role="rank" x="696" y="91.5" fill="#68657b" font-size="9" font-family="\'Geist Mono\', monospace">#1<')
        ...
        case(
            ...
            source.replace('      <text data-series="legacy-http" data-end="first" data-role="rank" x="304" y="91.5" fill="#68657b" font-size="9" font-family="\'Geist Mono\', monospace" text-anchor="end">#1</text>\n', "", 1),
        ...
        case(
            ...
            source.replace('      <text data-axis="2" data-state="Q3" x="560" y="416" fill="#68657b" font-size="9" font-family="\'Geist Mono\', monospace" letter-spacing="0.14em" text-anchor="middle">Q3</text>\n', "", 1),
        ...
        case(
            ...
            source.replace('d="M320,144 L440,200 L560,200 L680,144" fill="none" stroke="rgba(23,21,43,0.80)" stroke-width="1.2"',
                           'd="M320,144 L440,200 L560,200 L680,144" fill="none" stroke="#2f6fdb" stroke-width="2.4"'),
        ...
        case(
            ...
            source.replace('stroke="#2f6fdb" stroke-width="2.4"/>',
                           'stroke="#2f6fdb" stroke-width="1.2"/>', 1),
            source, "focus cue",
        ...
        case(
            ...
            source.replace('      <circle cx="560" cy="256" r="4" fill="#2f6fdb"/>\n', "", 1),
            source, "no dot at",
            "a vertex with no dot",
        )
        case(
            failures, directory, "small-dot",
            source.replace('<circle cx="680" cy="368" r="4" fill="#2f6fdb"/>',
                           '<circle cx="680" cy="368" r="3" fill="#2f6fdb"/>'),
            source, "dot size",
