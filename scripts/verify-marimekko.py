...
Usage:
    ...
    python3 scripts/verify-marimekko.py skills/mega-diagram/assets/example-marimekko.html
...
ACCENT_RE = re.compile(
    r"#2f6fdb\b|#6e9bea\b|rgba\(\s*235\s*,\s*108\s*,\s*54\b|rgba\(\s*240\s*,\s*138\s*,\s*89\b",
    re.IGNORECASE,
)
