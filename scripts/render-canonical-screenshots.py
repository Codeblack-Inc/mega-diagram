#!/usr/bin/env python3
"""Render the 41 canonical minimal-light examples and record their digests."""
...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        browser = playwright.chromium.launch(channel=os.environ.get("PLAYWRIGHT_CHANNEL") or None)
        ...
        for index, slug in enumerate(slugs, 1):
            ...
            # mega: README captures keep the white page paper; diagram SVGs themselves are transparent.
            ...
            print(f"[{index:02d}/41] {slug}: {width}x{height}")
        browser.close()
