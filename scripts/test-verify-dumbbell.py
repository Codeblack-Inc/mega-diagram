...
def test_rejected_treatments_are_caught():
    ...
    hairline = composite("#17152b", 0.25, "#ffffff")
    ok(contrast(hairline, "#ffffff") < 3.0,
       "the original 25%% hairline connector is correctly under 3:1")
    # mega: the blue accent clears 3:1 unstroked; upstream tangerine did not.
    ok(contrast("#2f6fdb", "#ffffff") >= 3.0,
       "the mega accent endpoint clears 3:1 on light paper")
    ok(contrast("#8a879c", "#ffffff") < 4.5,
