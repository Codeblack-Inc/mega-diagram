"""Fetch and normalize the icon set for the mega-diagram skill.
...
so they inherit ink from context, and emits two artifacts:
  ...
  - skills/mega-diagram/references/primitive-icons.md  (catalog with snippets)
  - skills/mega-diagram/assets/icons.html               (visual gallery)
...
MD_OUT = REPO / "skills" / "mega-diagram" / "references" / "primitive-icons.md"
HTML_OUT = REPO / "skills" / "mega-diagram" / "assets" / "icons.html"
...
def fetch(url: str) -> str | None:
    try:
        req = urllib.request.Request(
            url, headers={"User-Agent": "mega-diagram-build/1.0 (https://github.com)"}
        )
...
<head>
  ...
  <title>Icon library · mega-diagram</title>
  <link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Geist:wght@400;500;600&family=Geist+Mono:wght@400;500;600&display=swap" rel="stylesheet">
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
      --color-paper:   #ffffff;
      --color-paper-2: #f6f5fa;
      --color-ink:     #17152b;
      --color-muted:   #68657b;
      --color-soft:    #8a879c;
      --color-rule:    rgba(23,21,43,0.12);
      --color-accent:  #2f6fdb;
...
<body>
  <div class="container">
    <div class="header">
      <p class="eyebrow">Icons · mega-diagram</p>
      <h1>Icon library</h1>
