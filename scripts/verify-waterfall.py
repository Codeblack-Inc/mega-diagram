...
Usage:
    ...
    python3 scripts/verify-waterfall.py skills/mega-diagram/assets/example-waterfall.html
...
def check_sign_treatment(bars: list[Bar], errors: list[str], paper: str) -> None:
    ...
    THEME_TREATMENTS = {
        "#17152b": ("rgba(212,210,222,0.15)", "#d4d2de"),
        "#ffffff": ("rgba(104,101,123,0.15)", "#68657b"),
    }
