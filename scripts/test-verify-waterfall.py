...
GOOD = ROOT / "skills/mega-diagram/assets/example-waterfall.html"
...
def main() -> int:
    ...
    cases = (
        ...
        (
            ...
            '<rect x="832" y="196" width="96" height="224" fill="rgba(23,21,43,0.08)"',
            '<rect x="832" y="160" width="96" height="260" fill="rgba(23,21,43,0.08)"',
            "shared scale puts",
        ),
        (
            "bridge lie: a bridge is stretched past its two running levels",
            '<rect x="688" y="146" width="96" height="50" fill="rgba(47,111,219,0.12)"',
            '<rect x="688" y="146" width="96" height="70" fill="rgba(47,111,219,0.12)"',
            "shared scale puts",
        ),
        (
            "missing carry: a gap has no connector conserving the total",
            '<line x1="496" y1="167" x2="544" y2="167" stroke="rgba(23,21,43,0.55)" stroke-width="1" data-carry="266"/>',
            "",
            "no carry spans it",
        ),
        (
            ...
            '<line x1="496" y1="167" x2="544" y2="167" stroke="rgba(23,21,43,0.55)" stroke-width="1" data-carry="266"/>',
            '<line x1="496" y1="146" x2="544" y2="146" stroke="rgba(23,21,43,0.55)" stroke-width="1" data-carry="266"/>',
            "level sits at",
        ),
        (
        ...
        (
            ...
            '<rect x="400" y="131" width="96" height="36" fill="#ffffff" stroke="#68657b" stroke-width="1" data-role="delta" data-value="-38"',
            '<rect x="400" y="131" width="96" height="36" fill="rgba(104,101,123,0.15)" stroke="#68657b" stroke-width="1" data-role="delta" data-value="-38"',
            "share the same fill",
        ),
        (
        ...
        (
            ...
            '<text x="448" y="179" fill="#68657b" font-size="8" '
            'font-family="\'Geist Mono\', monospace" text-anchor="middle">\u2212 38</text>'.replace("\u2212 ", "\u2212"),
            '<text x="5" y="5" fill="#68657b" font-size="8" '
            'font-family="\'Geist Mono\', monospace" text-anchor="middle">\u2212 38</text>'.replace("\u2212 ", "\u2212"),
        ...
        (
            ...
            '<rect x="256" y="131" width="96" height="61" fill="rgba(104,101,123,0.15)" stroke="#68657b"',
            '<rect transform="translate(0 80)" x="256" y="131" width="96" height="61" fill="rgba(104,101,123,0.15)" stroke="#68657b"',
            "waterfall bar carries transform",
        ),
        (
            "ancestor transform: a group moves a bar away from its declared coordinates",
            '<rect x="256" y="131" width="96" height="61" fill="rgba(104,101,123,0.15)" stroke="#68657b" stroke-width="1" data-role="delta" data-value="+64" data-name="Headcount"/>',
            '<g transform="translate(0 80)"><rect x="256" y="131" width="96" height="61" fill="rgba(104,101,123,0.15)" stroke="#68657b" stroke-width="1" data-role="delta" data-value="+64" data-name="Headcount"/></g>',
            "ancestor transform",
        ),
        (
        ...
        (
            ...
            '<rect x="256" y="131" width="96" height="61" fill="rgba(104,101,123,0.15)" stroke="#68657b"',
            '<rect x="256" y="131" width="96" height="61" fill="rgba(47,111,219,0.12)" stroke="#2f6fdb"',
            "at most one bar",
        ),
        (
