...
color: it resolves to #17152b on light paper and #ffffff on dark. One ramp,
...
#17152b paper: larger cells are *lighter* there. `lint-skin.py` reads colors,
...
Usage:
    ...
    python3 scripts/verify-skin-polarity.py skills/mega-diagram/assets/example-treemap-dark.html
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "      skills/mega-diagram/assets/example-treemap-dark.html\n"
            "\n"
            "  # a light/dark pair, to prove one sentence serves both\n"
            "  python3 scripts/verify-skin-polarity.py \\\n"
            "      skills/mega-diagram/assets/example-treemap.html \\\n"
            "      skills/mega-diagram/assets/example-treemap-dark.html\n"
            "\n"
            "EXIT: 0 clean, 1 findings, 2 usage.\n"
        ),
