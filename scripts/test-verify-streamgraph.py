...
SHIPPED = ROOT / "skills/mega-diagram/assets/example-streamgraph.html"
...
def run_cases(h):
    ...
    h.expect_clean(
        ...
        document(figure()
                 + '  <path d="M 0 0 L 4 4 Z" fill="#17152b"/>\n'),
    )
    ...
    h.expect_finding(
        ...
        document('  <path d="M 0 0 L 4 4 Z" fill="#17152b"/>\n'),
        r"presents as a streamgraph but declares 0 verifiable layer",
    ...
    h.expect_clean(
        ...
        document(figure()).replace(
            ' fill="#17152b"/>', ' d="M 0 0 Z" fill="#17152b"/>', 1),
    )
