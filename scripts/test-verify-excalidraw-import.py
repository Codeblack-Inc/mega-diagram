...
REFERENCE = Path("skills/mega-diagram/references/import-excalidraw.md")
EXAMPLE = Path("skills/mega-diagram/assets/example-import-excalidraw.html")
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="mega-diagram-excalidraw-test-") as tmp_dir:
        ...
        stale_name = "/mega-diagram:import"
        valid_name = "/mega-diagram:import-excalidraw"
