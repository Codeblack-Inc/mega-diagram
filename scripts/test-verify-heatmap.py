...
GOOD = ROOT / "skills/mega-diagram/assets/example-heatmap.html"
GOOD_DARK = ROOT / "skills/mega-diagram/assets/example-heatmap-dark.html"
GOOD_FULL = ROOT / "skills/mega-diagram/assets/example-heatmap-full.html"
...
FOCAL_CELL = (
    ...
    'x="520" y="124" width="116" height="56" fill="rgba(47,111,219,0.85)"'
)
FIRST_NONFOCAL = (
    'data-row="auth" data-col="S1" data-value="4" '
    'x="160" y="64" width="116" height="56" fill="rgba(23,21,43,0.29)"'
)
HIGH_VALUE_CELL = (
    'data-row="billing" data-col="S3" data-value="9" '
    'x="400" y="244" width="116" height="56" fill="rgba(23,21,43,0.65)"'
)
LOW_VALUE_CELL = (
    'data-row="notifications" data-col="S1" data-value="1" '
    'x="160" y="304" width="116" height="56" fill="rgba(23,21,43,0.07)"'
)
# A non-focal cell used as the "missing" anchor in N2
MISSING_TARGET = (
    'data-row="billing" data-col="S6" data-value="3" '
    'x="760" y="244" width="116" height="56" fill="rgba(23,21,43,0.22)"'
)
# A cell with value=5 used as the inconsistent-opacity anchor in N5
FIVE_VALUE_CELL = (
    'data-row="auth" data-col="S2" data-value="5" '
    'x="280" y="64" width="116" height="56" fill="rgba(23,21,43,0.36)"'
)
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        second_focal = FIRST_NONFOCAL.replace(
            'fill="rgba(23,21,43,0.29)"',
            'data-focal="true" fill="rgba(47,111,219,0.85)"',
        )
        case(
            failures,
            d,
        ...
        dark_bad_focal_text = GOOD_DARK.read_text(encoding="utf-8").replace(
            ...
            'fill="#ffffff" font-size="10" font-weight="600" font-family="\'Geist\', sans-serif" text-anchor="middle">47%</text>',
            1,
        )
        case(
            failures,
