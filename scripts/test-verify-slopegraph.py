...
SHIPPED = ROOT / "skills/mega-diagram/assets/example-slopegraph.html"
...
def series(name: str, frm: float, to: float, y1=None, y2=None,
    ...
    return "  <line %s stroke=\"#17152b\" stroke-width=\"1.2\"/>\n" % " ".join(parts)
...
def run_cases(h: Harness) -> int:
    ...
    for other in ("example-line.html", "example-bar.html", "example-treemap.html",
        ...
        path = ROOT / "skills/mega-diagram/assets" / other
        if path.exists():
    ...
    h.expect_finding(
        ...
        document('  <line x1="320" y1="40" x2="320" y2="420" stroke="#17152b"/>\n'),
    ...
    h.expect_finding(
        ...
        document('  <line data-series="a" data-from="nan" data-to="nan" x1="320" '
                 'y1="nan" x2="680" y2="nan" stroke="#17152b"/>\n'
                 + honest_rows_block()),
        r"not a finite number",
    )
    ...
    h.expect_clean(
        ...
        HEAD + CAPTIONS + "".join(
            ...
            "y1='%g' x2='680' y2='%g' stroke='#17152b'/>\n"
    ...
    h.expect_finding(
        ...
        document(honest_rows_block()
                 + "  <line data-series=unquoted data-from=1 data-to=2 "
                   "x1=320 y1=40 x2=680 y2=420 stroke='#17152b'/>\n"),
    ...
    h.expect_clean(
        ...
        document(honest_rows_block()
                 + '  <line x1="320" y1="40" x2="320" y2="420" stroke="#17152b"/>\n'
                   '  <line x1="40" y1="492" x2="64" y2="492" stroke="#2f6fdb"/>\n'),
    )
    ...
    h.expect_out_of_scope(
        ...
        "by the raw signal",
        plain_head + '  <line x1="320" y1="40" x2="320" y2="420" stroke="#17152b"/>\n'
